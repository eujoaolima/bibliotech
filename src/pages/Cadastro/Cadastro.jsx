          ...
          <Container fluid className="my-5">
            <div className="row">
              <div className="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div
                  id="container-login"
                  className="card border-0 shadow rounded-3  my-5 px-5"
                >
                  <div className="card-body p-1 p-sm-4"></div>
                  <p className="text-center">
                    <img src={logoIcon} width="70%" alt="Logo do app" />
                  </p>
                  <h5 class="card-title mb-3 fw-light fs-3 text-muted">
                  ...
                  <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Form.Group className="mb-3" controlId="password">
                      ...
                      <div className="d-grid mb-2">
                        ...
                        >
                          <i className="bi bi-google" width="32"></i> Cadastrar
                          com o Google
                        </Button>
                      </div>
                      <div className="d-grid mb-2">
                        ...
                        >
                          {" "}
                          <i className="bi bi-github me-1" width="32"></i>
                      ...
                      <div className="d-grid mb-5">
                        ...
                        >
                          {" "}
                          <i className="bi bi-facebook" width="32"></i>{" "}
